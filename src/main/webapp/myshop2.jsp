...
<head>
    ...
    .this_bot{width: 1024px; height: 131px; border:1px solid rgb(223, 215, 215); font-size: 13px;
    border-top: none;}
    .this_bot span{position: relative; top:27px; left: 20px; color: rgb(153, 148, 148)}
    .this_bot1{height: 80px; border-bottom:1px solid rgb(223, 215, 215)}
    .this_bot2 span{position: relative; top:14px;}
    .this_bot3 {font-size: 13px; margin-top: 25px; color: rgb(153, 148, 148);}
