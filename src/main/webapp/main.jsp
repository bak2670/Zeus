...
<body>
	<div class="mainHeader">
		<div class="topHeader">
			<div class="headerBox">
				...
				<div class="headerMenu">
					...
					<div class="storeBox1">
						<div class="storeBox2">
							<a class="storeBtn" href="./myshop1.html">내 상점</a>
							<div class="storeView">
								<a class="storeclick" href="./myshop1.html">내 상품</a><a
									class="storeclick" href="./myshop3.html">찜한상품</a><a
									class="storeclick" href="./AccountSet.html">계정설정</a><a
									class="storeclick" href="./notice.html">고객센터</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="zeusTop">
			<div class="zeusBox1">
				<div class="zeusBox2">
					<a class="zeusLogo" href="./title.html"><img
		...
		<div class="zzimSideBox1">
			<div class="zzimSideBox2">
				<div class="zzim1">
					...
					<div class="zzim1Num">
						<a class="zzim1Btn" href="./myshop3.html"><img
...
autoplaySpeed: 2000,
	...
	<div class="modal_wrap">
		<div class="popup" id="pop1">
			...
			<ul class="login_list">
				<li class="kakao"><a href="#">카카오로 이용하기</a></li>
				<li class="naver"><a href="#">네이버로 이용하기</a></li>
